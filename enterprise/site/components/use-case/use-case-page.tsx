      ...
      <SectionContainer className="flex h-full max-w-[1180px] items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="cta" className="h-8 rounded-md px-4 text-[13px]" asChild>
            <a href={CTA_URL} target="_blank" rel="noreferrer" data-umami-event="book-demo-use-case-nav">{CTA_LABEL}</a>
          </Button>
        </div>
      </SectionContainer>
    </header>
          ...
          <SectionContainer className="max-w-[1180px]">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              <Button variant="cta" className="h-10 rounded-md px-5 text-[13px] font-medium" asChild>
                <a href={CTA_URL} target="_blank" rel="noreferrer" data-umami-event="book-demo-use-case-hero">{CTA_LABEL}</a>
              </Button>
              {useCase.liveUrl ? (
          ...
          <SectionContainer className="max-w-[1180px]">
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-8 md:p-10">
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3">
                <Button variant="cta" className="h-10 rounded-md px-5 text-[13px] font-medium" asChild>
                  <a href={CTA_URL} target="_blank" rel="noreferrer" data-umami-event="book-demo-use-case-footer">{CTA_LABEL}</a>
                </Button>
                <Link
                  href="/use-cases"
