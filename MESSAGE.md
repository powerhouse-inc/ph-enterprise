...
- Open-source stack and inspectable implementation.
- Portable data and schemas.
- Model choice by workflow sensitivity.
- Human approval gates for consequential steps.
- Attributable operation history built into the workflow.
- No rip-and-replace requirement for existing systems.

## Proof

- Powerhouse and BAI cite production systems already built on the stack, including Achra, Sky/Fusion, Connect modules, and RFP Hub.
- The BAI site states that 22 business modules are in active production.
- The BAI site attributes a 65% reduction in time spent manually reviewing invoices to Wouter Vonk, CEO of Powerhouse.
- The site should use real product screenshots from existing workflow software wherever possible.
...
Use evidence, qualification, or customer-specific scoping for claims about:

- quantified time savings beyond the attributed 65% invoice-review result
- compliance with specific laws, regulations, or standards
- data residency guarantees
- local model deployment in a specific customer environment
- no vendor access to customer data
- production references outside the Powerhouse, BAI, Achra, Sky/Fusion, Connect, and RFP Hub examples
- contractual SLAs
- security certifications
- model training policies of third-party AI providers

## What The Homepage Should Not Say

- Do not present Powerhouse as a buffet of unrelated industries.
- Do not make manufacturing, legal, claims, sports betting, HR, finance, or procurement homepage pillars.
- Do not lead with Clint, Connect, Fusion, Switchboard, Renown, or other component names.
- Do not describe Powerhouse as a chatbot, copilot, data-cleaning service, consulting firm, or generic automation agency.
- Do not overstate regulatory compliance, data sovereignty, security certifications, or guaranteed business outcomes.
- Do not imply rip-and-replace migration.
- Do not use abstract AI hype where a workflow, artifact, permission boundary, or product screenshot would be clearer.
